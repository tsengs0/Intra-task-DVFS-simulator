...
static vector<char_str> task_id;
static char_str task_id_temp;
static vector<char_str> wcec, acec, bcec;
static char_str wcec_temp, acec_temp, bcec_temp;

static vector<array_int_element> task_succ;
static vector<int> succ;
static int succ_int_temp;
