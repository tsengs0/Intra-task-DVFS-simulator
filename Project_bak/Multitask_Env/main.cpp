...
// Settings of each task's CFG information
	...
	Src_CFG task2((char*) "task2.cfg", time_management, checkpoints_1, &cycle_trace_2, task_wcet_info[1], exe_path);
...
// Settings of Inter-task
	...
	src_inter.push_back({0.0, /*start_time*/0.0, 1, 3000.0, 605, 3000.0, (char) ZOMBIE});
	src_inter.push_back({0.0, /*start_time*/0.0, 0, 1000.0, 425, 1000.0, (char) ZOMBIE});
//=======================================================================================================================================================//
...
//=======================================================================================================================================================//	
	...
	cout << "0 us - " << endl;
	for(float cur_time = 0.001; cur_time <= 3000; ) {
