...
# Insert your script here 
 for i in {0..2..1}
   do
 	...
 	../bin/mul_StaticDVFS $alpha_tsk0 $alpha_tsk1 $alpha_tsk2  $alpha_tsk3 $alpha_tsk4 1000 > log.txt 
...
#temp=$(( temp+10 ))
 ...
 ../bin/mul_NonDVFS $alpha_tsk0 $alpha_tsk1 $alpha_tsk2  $alpha_tsk3 $alpha_tsk4 1000 > log.txt 
 ../bin/mul_ProfileDVFS $alpha_tsk0 $alpha_tsk1 $alpha_tsk2  $alpha_tsk3 $alpha_tsk4 1000 > log.txt 

echo Creating result folders and move txt and csv files to each corresponding folders
 mkdir ../result/identifier/Experiment_$1/ProfileDVFS&&
 mkdir ../result/csv/Experiment_$1/ProfileDVFS &&
 mkdir ../result/identifier/Experiment_$1/NonDVFS&&
 mkdir ../result/csv/Experiment_$1/NonDVFS &&
 
 mv *DVFS.Overhead.*.txt ../result/identifier/Experiment_$1/ProfileDVFS &&
 mv DVFS.Overhead.*.csv ../result/csv/Experiment_$1/ProfileDVFS &&
 mv *NonDVFS.*.txt ../result/identifier/Experiment_$1/NonDVFS &&
 mv NonDVFS.*.csv ../result/csv/Experiment_$1/NonDVFS
